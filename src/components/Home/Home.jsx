                                    ...
                                    <div className="card-body">
                                        <div className="d-flex justify-content-center align-items-center flex-column">
                                            <div className="avatar avatar-2xl">
                                                <img src="https://img.freepik.com/free-photo/close-up-portrait-young-bearded-man-white-shirt-jacket-posing-camera-with-broad-smile-isolated-gray_171337-629.jpg?t=st=1711116460~exp=1711120060~hmac=5db2ab1bb97f5e2e5c01a18d6d41a1d48b8eee37caa5c743e3c211e273fcb90b&w=1380" alt="Avatar" />
                                            </div>
                                ...
                                <div className="card">
                                    <div className="card-body">
                                        ...
                                        <div className="d-flex justify-content-between">
                                            ...
                                            <button type="submit" className="btn btn-secondary">Profile Details</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
